      ...
      <div className="max-w-screen-lg mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold mb-4">Serenity Spa</h3>
            <p className="text-gray-400">Địa chỉ: 123 Nguyễn Huệ, Quận 1, TP.HCM</p>
            <p className="text-gray-400">Hotline: 0123.456.789</p>
          </div>
          <div className="text-center">
            <h3 className="text-xl font-bold mb-4">Giờ Mở Cửa</h3>
            <p className="text-gray-400">Thứ 2 - Thứ 6: 9:00 - 21:00</p>
        ...
        <div className="text-center mt-8 pt-8 border-t border-gray-800">
          <p className="text-gray-400">&copy; 2023 Serenity Spa. Đã đăng ký bản quyền.</p>
        </div>
      </div>
    </footer>
  );
